<h2><a href="https://www.geeksforgeeks.org/problems/c-template/1?page=1&category=CPP&difficulty=Easy&sortBy=accuracy">C++ Template</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px"><a href="http://quiz.geeksforgeeks.org/templates-cpp/" target="_blank">Template in C++</a>&nbsp;is a feature. We write code once and use it for any data type including user defined data types.&nbsp;</span></p>
